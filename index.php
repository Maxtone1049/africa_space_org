...
<link rel="stylesheet" href="css/style.css">
    <title>Home | Africa United Space</title>
</head>
<body>
    ...
    <div class="header">
        ...
        <header class="subhead">
            ...
            <nav class="">
                ...
                <ul>
                <li> <a href="about.php" class="touch">About Us</a></li>
        ...
        <!-- header end -->
         ...
         <div class="container">
            <div class="mainone">
                <span>
                    Unveiling the Wonders of the Universe Space
                </span>
            </div>
            <div class="maintwo">
    ...
    <Section class="charge">
        <div class="phaseone">
            <span>We are committed to making space <br> science accessible to every African.</span>
        </div>
        <div class="getter">
            <div class="tags">
                <h3>01.</h3>
    ...
    <!-- Section one End -->
     ...
     <!-- Quiz Section -->
      <section class="quiz">
        <div class="end">
            <div class="sep">
                <span class="big">Take a quick Trivia</span>
                <span class="bh">Test your Knowledge of <br> Space Science</span>
            </div>
            <a href="#">Let's Go</a>
        </div>
      </section>
      <!-- Quiz Section -->
       <!-- Newsletter Section -->
        <section class="news">
            <div class="holder">
                <h3>Stay up to date with our Newsletter
                </h3>
                <span>
