    ...
    <section class="maindock">
        ...
        <div class="product-details">
            ...
            <div class="color-options">
                <span>Colour: <span id="product-colour"></span></span>
            </div>

            <!-- Size Options -->
            <div class="size">
                <span>Size: <span id="product-size"></span></span>
            </div>
...
if (productDetails) {
    ...
    if (productColour) {
        productColour.innerText = productDetails.colours;
    }
    if (productSize ) {
    ...
    document.querySelector('.cartAdd').addEventListener('click', () => {
        ...
        window.location.href = "detailpag.php";
